...
To avoid a knife-edge winner-take-all location response, each firm receives an idiosyncratic decision perturbation favoring $A$ relative to $B$,
\begin{equation}
\varepsilon_i\sim U[-H,H],\qquad H>0,
\label{eq:location-shock}
\end{equation}
independently across firms. We interpret $\varepsilon_i$ as a Harsanyi-style purification device for the discrete location decision, not as consumption, profit, or a real resource. It therefore affects the firm's location rule but is not itself a component of material social surplus. Given continuation profits, firm $i$ chooses $A$ when its deterministic payoff advantage of $A$ plus $\varepsilon_i$ is nonnegative. Equivalently, the welfare criterion evaluates the underlying material economy and integrates over the location distribution induced by the perturbation; it does not assign welfare weight to the perturbation draw itself.
