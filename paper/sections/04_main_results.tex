...
\end{equation}
The first inequality says that redundancy crowd-out dominates the direct engineering benefit at the national margin; the second says that the local plant-attraction benefit is large enough to overturn one quarter of that national marginal loss. The full theorem below adds the global policy and equilibrium requirements.
...
\end{equation}
Every downstream continuation used to evaluate first-stage deviations is unique and interior on the frozen policy domain.
\end{theorem}
