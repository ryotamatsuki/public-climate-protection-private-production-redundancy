...
The proof is computer-assisted but not calibration-based. Exact rational polynomials certify the relevant marginal signs and isolate the unique symmetric government first-order-condition root at the canonical witness. A deterministic whole-domain continuation audit independently re-solves location and backup choices for government deviations. The strict sign and interiority conditions, together with the simple government root, imply persistence in an open neighborhood of primitives. Appendix~\ref{app:verification} documents the certificate and separates exact algebra from numerical global-deviation checks.
