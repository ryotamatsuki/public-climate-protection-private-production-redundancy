...
\item On the maintained symmetric interior branch, industries with closer substitutes have lower equilibrium backup readiness because the sole-survivor versus duopoly profit wedge is larger. This is a \emph{level} prediction. The model does not generally predict that product substitutability strengthens the marginal crowd-out effect of public protection. At the canonical co-located symmetric origin,
\begin{equation}
\frac{\partial^2 r^C}{\partial q\,\partial\gamma}
=-\frac{26550065039062500}{13482801445834729}<0,
\label{eq:cross-partial-prediction}
\end{equation}
so $\partial r^C/\partial q$ is smaller at higher $\gamma$; because $q=q_0-a$, the readiness reduction induced by an incremental increase in protection is locally \emph{weaker}, not stronger, when products are closer substitutes at this canonical point.
